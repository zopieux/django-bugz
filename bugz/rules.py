...
can_edit_ticket = is_staff | (is_authenticated & ticket_is_unlocked & is_own_ticket)
...
add_rule("bugz.can_edit_comment", is_staff | (is_authenticated & is_own_comment_author))
